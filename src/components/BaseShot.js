...
var oldBackgroundImage = 'sb08_intro_bg';
...
let titleAudio = new loadSound('ep_51_audio_22');

let bodyAudio = new loadSound('ep_51_audio_22');
let subBodyAudio = new loadSound('ep_51_audio_22');

let wordAudio1 = new loadSound('ep_51_audio_22');
let wordAudio2 = new loadSound('ep_51_audio_22');
let wordAudio3 = new loadSound('ep_51_audio_22');
let wordAudio4 = new loadSound('ep_51_audio_22');
...
let audioListForMute = [
    ...
    wordAudio3, wordAudio4, clickAudio, clapAudio, backAudio, buzzAudio, yeahAudio, tingAudio, wooAudio, bubbleAudio
]
var isOff = false;
        ...
        >
            <div
                ...
                <img draggable={false} height={"100%"}
                    ref={myImage}
                    src={prePathUrl() + "images/sb_51_bg/sb_51_intro_bg2_01.svg"}
                />
            </div>
            <div
                ref={imageBack1}
